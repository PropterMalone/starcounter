...
const COMMON_WORDS = new Set([
  ...
  'want', 'need', 'think', 'know', 'feel', 'see', 'saw', 'seen', 'look', 'looking',
  'watch', 'watching', 'watched', 'love', 'loved', 'like', 'liked', 'hate', 'hated',
  'take', 'takes', 'took', 'taken', 'make', 'makes', 'made', 'get', 'gets', 'got',
  'give', 'gives', 'gave', 'come', 'comes', 'came', 'go', 'goes', 'went', 'gone',
  'said', 'says', 'tell', 'told', 'ask', 'asked', 'try', 'tried', 'use', 'used',
  'find', 'found', 'keep', 'kept', 'let', 'begin', 'began', 'seem', 'seems',
  'help', 'show', 'hear', 'heard', 'play', 'run', 'move', 'live', 'believe',
  'hold', 'bring', 'happen', 'write', 'provide', 'sit', 'stand', 'lose', 'pay',
  'meet', 'include', 'continue', 'set', 'learn', 'change', 'lead', 'understand',
  'remember', 'follow', 'stop', 'create', 'speak', 'read', 'spend', 'grow',
  'open', 'walk', 'win', 'offer', 'appear', 'buy', 'wait', 'serve', 'die',
  'send', 'expect', 'build', 'stay', 'fall', 'cut', 'reach', 'kill', 'remain',

  // Adverbs (very common sentence starters)
  'absolutely', 'actually', 'already', 'also', 'always', 'anyway', 'apparently',
  'basically', 'certainly', 'clearly', 'completely', 'currently', 'definitely',
  'easily', 'especially', 'essentially', 'eventually', 'exactly', 'extremely',
  'finally', 'fortunately', 'frankly', 'frequently', 'generally', 'genuinely',
  'greatly', 'hardly', 'heavily', 'highly', 'honestly', 'hopefully', 'however',
  'immediately', 'importantly', 'increasingly', 'indeed', 'initially', 'instead',
  'interestingly', 'just', 'largely', 'lately', 'later', 'likely', 'literally',
  'mainly', 'maybe', 'meanwhile', 'merely', 'mostly', 'naturally', 'nearly',
  'necessarily', 'never', 'normally', 'notably', 'obviously', 'occasionally',
  'often', 'only', 'originally', 'otherwise', 'overall', 'particularly',
  'perhaps', 'personally', 'possibly', 'potentially', 'practically', 'precisely',
  'presumably', 'previously', 'primarily', 'probably', 'properly', 'quickly',
  'quite', 'randomly', 'rarely', 'rather', 'really', 'reasonably', 'recently',
  'relatively', 'remarkably', 'sadly', 'seriously', 'significantly', 'similarly',
  'simply', 'slightly', 'slowly', 'somehow', 'sometimes', 'somewhat', 'soon',
  'specifically', 'still', 'strongly', 'suddenly', 'supposedly', 'surely',
  'surprisingly', 'technically', 'therefore', 'thoroughly', 'though', 'thus',
  'together', 'totally', 'truly', 'typically', 'ultimately', 'unfortunately',
  'unless', 'unlikely', 'usually', 'very', 'virtually', 'well', 'widely',

  // Pronouns and determiners
  'the', 'a', 'an', 'this', 'that', 'these', 'those', 'my', 'your', 'his', 'her',
  'its', 'our', 'their', 'some', 'any', 'no', 'every', 'each', 'all', 'both',
  'few', 'more', 'most', 'other', 'another', 'such', 'what', 'which', 'who',
  'whom', 'whose', 'whatever', 'whoever', 'whichever',

  // Conjunctions and prepositions
  'and', 'or', 'but', 'if', 'of', 'in', 'on', 'at', 'to', 'for', 'with', 'without',
  'about', 'against', 'between', 'into', 'through', 'during', 'before', 'after',
  'above', 'below', 'from', 'up', 'down', 'out', 'off', 'over', 'under', 'again',
  'further', 'then', 'once', 'here', 'there', 'when', 'where', 'why', 'how',
  'because', 'since', 'while', 'although', 'though', 'unless', 'until', 'whether',

  // Common nouns (not typically titles on their own)
  'movie', 'film', 'show', 'series', 'book', 'song', 'album', 'game', 'story',
  'people', 'person', 'man', 'woman', 'child', 'children', 'guy', 'girl', 'boy',
  'family', 'friend', 'friends', 'group', 'team', 'company', 'government',
  'world', 'country', 'state', 'city', 'place', 'home', 'house', 'school',
  'life', 'time', 'year', 'years', 'day', 'days', 'week', 'month', 'night',
  'morning', 'evening', 'today', 'yesterday', 'tomorrow', 'moment', 'minute',
  'thing', 'things', 'stuff', 'something', 'nothing', 'everything', 'anything',
  'way', 'part', 'case', 'point', 'fact', 'problem', 'question', 'answer',
  'reason', 'result', 'end', 'kind', 'sort', 'type', 'lot', 'bit', 'number',
  'work', 'job', 'business', 'money', 'power', 'hand', 'side', 'head', 'eye',
  'face', 'body', 'water', 'food', 'car', 'door', 'room', 'name', 'word',
  'ocean', 'oceans', 'dude', 'dudes', 'guys', 'folks', 'kids', 'movies',

  // Adjectives (often before nouns, not titles)
  'good', 'great', 'bad', 'best', 'worst', 'nice', 'cool', 'awesome', 'amazing',
  'beautiful', 'big', 'small', 'little', 'long', 'short', 'high', 'low', 'new',
  'old', 'young', 'different', 'same', 'other', 'important', 'large', 'real',
  'true', 'right', 'wrong', 'sure', 'possible', 'able', 'free', 'full', 'special',
  'easy', 'hard', 'clear', 'certain', 'whole', 'particular', 'recent', 'major',
  'personal', 'local', 'national', 'international', 'political', 'social',
  'public', 'private', 'main', 'common', 'general', 'single', 'simple', 'final',
  'past', 'present', 'future', 'early', 'late', 'available', 'popular', 'similar',

  // Archaic/poetic (for "O Brother Where Art Thou" type handling)
  'art', 'where', 'thou', 'thee', 'thy', 'thine', 'brother', 'o',

  // Other common sentence starters
  'plus', 'minus', 'super', 'kinda', 'sorta', 'gotta', 'gonna', 'wanna',
  'many', 'much', 'several', 'various', 'numerous', 'multiple',
]);
  ...
  private extractRareWords(text: string, defaultMediaType?: MediaType): Array<MediaMention> {
    ...
    while ((match = rareWordPattern.exec(text)) !== null) {
      ...
      const alwaysExtractTitles = new Set([
        'ronin', 'amélie', 'amelie', 'tenet', 'arrival', 'alien', 'aliens',
        'predator', 'jaws', 'psycho', 'vertigo', 'notorious', 'zodiac',
        'chinatown', 'fargo', 'heat', 'collateral', 'sicario', 'prisoners',
        'interstellar', 'dunkirk', 'oppenheimer', 'gladiator', 'braveheart',
        'unforgiven', 'tombstone', 'gettysburg', 'patton', 'platoon',
      ]);
      ...
      const ambiguousWords = new Set([
        ...
        'chicago', 'paris', 'rome', 'berlin', 'munich', 'london', 'brooklyn',
        'philadelphia', 'casablanca', // Casablanca is OK as multi-word "Casablanca" but risky alone
        // Genre words
        'western', 'horror', 'comedy', 'drama', 'thriller', 'action', 'romance',
        'musical', 'fantasy', 'animation', 'documentary', 'mystery', 'crime',
        // Nationality/language words (often false positives like "French" → "French Blood")
        'french', 'german', 'italian', 'spanish', 'american', 'british', 'english',
        'japanese', 'chinese', 'korean', 'russian', 'indian', 'mexican', 'canadian',
        // Other ambiguous words
        'blood', 'love', 'war', 'life', 'death', 'hope', 'fear', 'time', 'gold',
        'silver', 'blue', 'green', 'black', 'white', 'dark', 'light', 'night', 'day',
        'oceans', 'ocean', // Should only count as "Ocean's Eleven" etc.
      ]);
